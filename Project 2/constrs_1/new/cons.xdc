...
set_max_delay 6 -from [all_registers] -to [all_outputs]
set_max_delay 6 -from [all_inputs] -to [all_registers]]
...
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { c_out }]; #IO_L16N_T2_A15_D31_14 Sch=led[8]
