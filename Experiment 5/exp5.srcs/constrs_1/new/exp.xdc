...
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets HEX_reg[0]_i_8];
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets Qn_OBUF];
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets Q_OBUF];
### Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clka }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
#set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { LEDR }]; #IO_L10P_T1_D14_14 Sch=led16_g
...
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { KEYR }]; #IO_L9P_T1_DQS_14 Sch=btnc
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { KEYD }]; #IO_L4N_T0_D05_14 Sch=btnu
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { KEYH }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { CLEAR }]; #IO_L10N_T1_D15_14 Sch=btnr
